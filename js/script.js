// ---------------------------------------------------------------------------
// Environment shim: Ensure window.fetch is writable and has both getter/setter
  ...
  try {
    ...
    if (typeof window !== 'undefined') {
      try {
        ...
        // If defineProperty fails, keep native
      }
      window.addEventListener('error', function (event) {
        if (event && event.message && event.message.includes('property fetch')) {
